...
def initRKNN(rknnModel="rknn_toolkit_lite2/examples/yolov8/yolov8s.rknn", id=0):
    rknn_lite = RKNNLite()
...
def initRKNNs(rknnModel="rknn_toolkit_lite2/examples/yolov8/yolov8s.rknn", TPEs=1):
    rknn_list = []
    for i in range(TPEs):
